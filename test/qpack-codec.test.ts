...
import { QpackCodec } from '../../src/rtcfetcher/qpack/qpack-codec';
import { StreamRef } from '../../src/rtcfetcher/types/stream-ref';
...
describe('QpackCodec', () => {
    ...
    it('should encode and decode nested objects', () => {
        ...
        // Note: Arrays might be converted to object with numeric keys depending on implementation
        // or restored if inflation logic is smart.
        // Let's check current behavior. Our setPath logic handles arrays with numeric keys.
        expect(decoded).toEqual(obj);
    });
